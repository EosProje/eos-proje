                        ...
                        <section>
                            ...
                            <div className="prose prose-lg text-slate-600">
                                <p>
                                    ...
                                    Tüm süreçlerimiz (tekliflendirme, saha çalışması, modelleme, teslimat) dokümante edilmiş prosedürlere göre yürütülür.
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        ...
                        <div className="bg-[var(--color-deep-charcoal)] p-8 rounded-3xl text-white">
                            ...
                            <p className="text-slate-400 text-sm mb-6">
                                Resmi kalite politikası dokümanımızı ve taahhütnamemizi PDF formatında indirebilirsiniz.
                            </p>
