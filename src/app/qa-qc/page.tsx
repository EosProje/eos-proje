  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        ...
        {/* 3 Aşamalı Süreç */}
        <div className="mb-24">
          <h2 className="text-3xl font-black text-slate-900 mb-12">Üç Aşamalı Kalite Kontrol Sürec jimiz</h2>
                ...
                <div>
                  ...
                  <ul className="grid md:grid-cols-2 gap-3">
                    {[
                      ...
                      "View Template'lerin doğru uygulandığını göz den geçirir",
                ...
                <div>
                  ...
                  <ul className="grid md:grid-cols-2 gap-3">
                    {[
                      ...
                      "Modelin farklı Revit ver siyonlarında açılabilirliği",
        ...
        <div className="mb-24">
          ...
          <div className="space-y-4">
            {[
              { icon: <AlertTriangle className="w-6 h-6" />, title: "Overlapping Walls", desc: "İki duvarın içiçe geçmesi. Miktar çıksında hata yaratır. Join geometry ile düzeltilir." },
              { icon: <AlertTriangle className="w-6 h-6" />, title: "Unplaced Elements", desc: "Room, Space gibi elemanların view'da görunmemesi. Filter ayarlarıyla çözülür." },
