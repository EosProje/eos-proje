...
// caseStudies import gerekmeyebilir artık ama proje detayları olarak yine de koyabiliriz veya kaldırabiliriz.
// Şimdilik karmaşayı önlemek için basit tutuyorum.
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Eğer bu değişkenler yoksa mail gönderimi başarısız olur, ama frontend'de hata göstermemeliyiz (şimdilik)
