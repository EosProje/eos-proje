...
locale: "en"
alternates:
  tr: "/blog/lod-levels-differences"
schema:
  type: "Article"
  faq: true
images:
...
<ExpertQuote author="UÃ„Å¸ur Bilen" role="BIM Specialist, Eos Proje">
...
## Detailed Comparison of LOD LevelÃ…Å¸
...
- Performance data: 150 kW, 80 mÃ‚Â³/h, etc.

<Callout type="tip">
**LOD 300 Sweet Spot:**  
LOD 300 is the optimal level for as-built documentation, renovation projects, MEP coordination, and clash detection. The additional cost of moving to LOD 400 is Ã‚Â±40%, while the additional value is only 10%.
</Callout>
...
- Hanger locations with Ã‚Â±10mm tolerance
- Spool drawings
...
|--------|-----|-------------|
| Process Piping | 400 | Ã¢Å¡Â Ã¯Â¸Â Critical |
| Instrument Tubing | 350-400 | Ã¢Å¡Â Ã¯Â¸Â Critical |
| Structural Steel | 300-350 | Medium |
| Utility Piping | 300 | Low |
| HVAC | 300 | Low |
| Cable Tray | 300 | Low |
| Equipment (Major) | 350-400 | Ã¢Å¡Â Ã¯Â¸Â Critical |
...
The most critical difference is **precision and reliability**. In LOD 200, dimensions and locations are "approximate", in LOD 300 they are "exact". For example, in LOD 200 a pipe is shown as DN150 but its exact route is uncertain. In LOD 300, both diameter, route, and elevation are exact (Ã‚Â±10mm tolerance).
</FAQ>
...
Example: LOD 300 Ã¢â€°Ë† LOG 3 + LOI 3
...
**Author:** [UÃ„Å¸ur Bilen](https://linkedin.com/in/ugur-bilen) - BIM Modeling Specialist  
